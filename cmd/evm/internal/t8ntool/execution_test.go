...
func TestExecutionResultBlockAccessListMarshalsAsRLPBytes(t *testing.T) {
	...
	if output.BlockAccessList != "0xc0" {
		t.Fatalf("unexpected blockAccessList: have %q want %q", output.BlockAccessList, "0xc0")
	}
}
